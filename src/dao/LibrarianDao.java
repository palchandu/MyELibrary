...
public class LibrarianDao {
	...
	public static int save(LibrarianBean bean) {
		...
		try {
			...
			PreparedStatement ps=(PreparedStatement) con.prepareStatement("insert into E_LIBRARIAN(name,email,password,mobile) values(?,?,?,?)");
	...
	public static List view() {
		List list= new ArrayList<LibrarianBean>();
		try {
			Connection con=(Connection) DB.getCon();
			PreparedStatement ps=(PreparedStatement) con.prepareStatement("select * from E_LIBRARIAN");
